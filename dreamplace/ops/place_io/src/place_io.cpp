...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("apply_force", [](DREAMPLACE_NAMESPACE::PlaceDB& db, 
                pybind11::array_t<float, pybind11::array::c_style | pybind11::array::forcecast> const& x, 
                pybind11::array_t<float, pybind11::array::c_style | pybind11::array::forcecast> const& y) {apply_force(db, x, y);}, 
             "Apply_force Placement Solution (float)");
    m.def("apply_force", [](DREAMPLACE_NAMESPACE::PlaceDB& db, 
                pybind11::array_t<double, pybind11::array::c_style | pybind11::array::forcecast> const& x, 
                pybind11::array_t<double, pybind11::array::c_style | pybind11::array::forcecast> const& y) {apply_force(db, x, y);},
             "Apply_force Placement Solution (double)");
